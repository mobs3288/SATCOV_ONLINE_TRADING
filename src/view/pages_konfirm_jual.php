...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../assets/css/konfirm_jual_style.css">
</head>
<body>
                        ...
                        while($row = $result->fetch_assoc()) {
                                ...
                                <div class="kotak_login">
                                    ...
                                    <form action="../handler/Investor_handler.php" method="post">
                                        ...
                                        <button type="submit" class="tombol_sell" value = "sellStock" name = "sellStock">SELL</button><br><br>
                                    </form>
